...
// WatcherEx is the interface for Casbin watchers.
type WatcherEx interface {
	Watcher
	// UpdateForAddPolicy calls the update callback of other instances to synchronize their policy.
	// It is called after Enforcer.AddPolicy()
	UpdateForAddPolicy(sec string, ptype string, rule []string) error
	...
	UPdateForRemovePolicy(sec string, ptype string, rule []string) error
